...
print("PROGRAM START AT " + datetime.datetime.now() +  " -> PROGRAM LOOP")
...
while True: 
    ...
    if (current_date == datetime.datetime.today().strftime('%d_%m_%Y')):
        ...
        print("(ELSE) AT " + datetime.datetime.now() " -> MAIN EVENT LOOP")
